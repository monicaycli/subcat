...
versions::install.dates("fs", "2018-10-25", dependencies = TRUE)
versions::install.dates("here", "2018-10-25", dependencies = TRUE)
versions::install.dates("psych", "2018-11-15", dependencies = TRUE)
versions::install.dates("mice", "2018-11-15", dependencies = TRUE)
